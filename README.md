...
- 구현 내용과 기능 설명
    - Tab을 눌러 GroupBox 사이를 이동할 수 있음
    - Enter를 눌러 btnOrder_Click 이벤트를 호출
    - 방향키를 눌러 선택 아이템 사이를 이동할 수 있음
...
- 구현 내용과 기능 설명
    - 체크박스와 라디오버튼을 눌러 체크 유무가 변할 때마다 UpdateTotal 함수를 호출해 주문하기처럼 작동하도록 함
